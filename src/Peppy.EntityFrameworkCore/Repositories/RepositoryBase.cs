...
namespace Peppy.EntityFrameworkCore.Repositories
{
            ...
            where TEntity : class, IEntity<TPrimaryKey>
    {
        ...
        public virtual async Task<TEntity[]> QueryArrayAsync()
        {
        ...
        /// <returns>Array of entities</returns>
        public virtual async Task<TEntity[]> QueryArrayAsync(Expression<Func<TEntity, bool>> predicate)
        {
        ...
        /// <param name="predicate"></param>
        /// <returns>List of entities</returns>
        public virtual async Task<List<TEntity>> QueryListAsync(Expression<Func<TEntity, bool>> predicate = null)
        {
